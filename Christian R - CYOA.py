...
east_shopkeeper_platform = Room("East Shopkeeper Platform", 'northeast_inhibitor', 'southeast_inhibitor', None, None,
                                None, None, None, None, 'You are on a shopkeeper platform, he appears ecstatic.\n'
                                'There\'s two staircases one leading south and one leading west.', None)

west_shopkeeper_platform = Room("West Shopkeeper Platform", 'northeast_inhibitor', 'southeast_inhibitor', None, None,
                                None, None, None, None, 'You are on a shopkeeper platform, he appears ecstatic.\n'
                                'There\'s two staircases one leading south and one leading west.', None)
...
northeast_jungle = Room("Northeast Jungle", "bottom_of_the_northeast_stairs", "east_wolves_camp",
                        ...
                        'There appears to be a path to the west.\n'
                        'There\'s a path to the south and a path to the east.', None)
...
northwest_jungle = Room("Northwest Jungle", "bottom_of_the_northwest_stairs", "west_wolves_camp",
                        ...
                        'There appears to be a path to the east.\n'
                        'There\'s a path to the south and a path to the west.', None)
...
southeast_jungle = Room("Southeast Jungle", "bottom_of_the_southeast_stairs", "east_wraiths_camp",
                        ...
                        'There appears to be a path to the west.\n'
                        'There\'s a path to the east and a path to the south.', None)
...
southwest_jungle = Room("Southwest Jungle", "bottom_of_the_southwest_stairs", "west_wraiths_camp",
                        ...
                        'There appears to be a path to the east.\n'
                        'There\'s a path to the west and a path to the south.', None)
...
while True:
    ...
    if command == 'heal':
        ...
        if command == ('hey', 'yo wassup', 'yo', 'hello'):
            print("yo anyways there are some wolves up on the east side that need some 'loving' if you get what I'm"
                  "saying...I'm saying you should go kill them...like right now...")
    if command == 'hey':
        print("Theres a pack of wolves that are causing trouble around the east side.")

    if command == 'think':
        print("You become an intellectual.")
    ...
    if command == 'easter eggs':
        print("shrek, think, and snap")
